...
pub const scenes = [_]Scene{
    ...
    .{ .kind = .joint_heavy, .name = "JointHeavy", .bodies = 2_048, .colliders = 2_048, .joints = 8_192, .broad_pairs = 4_096, .contact_patches = 4_096, .contact_points = 16_384, .expected_contacts = 0, .budget = .{ .native_p95_ns = 600_000_000, .native_p99_ns = 700_000_000, .snapshot_p95_ns = 20_000_000, .rollback_8_p95_ns = 7_000_000_000, .max_workspace_bytes = 768 * 1024 * 1024 } },
