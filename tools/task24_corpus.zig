...
pub const scenes = [_]Scene{
    .{ .kind = .small, .name = "Small", .bodies = 64, .colliders = 64, .joints = 32, .broad_pairs = 256, .contact_patches = 256, .contact_points = 1_024, .expected_contacts = 90, .group_size = 4, .budget = .{ .native_p95_ns = 4_000_000, .native_p99_ns = 6_000_000, .snapshot_p95_ns = 2_000_000, .rollback_8_p95_ns = realtime_tick_ns, .max_workspace_bytes = 64 * 1024 * 1024 } },
    ...
    .{ .kind = .stress, .name = "Stress", .bodies = 8_192, .colliders = 8_192, .joints = 8_192, .broad_pairs = 131_072, .contact_patches = 32_768, .contact_points = 131_072, .expected_contacts = 28_672, .group_size = 8, .budget = .{ .native_p95_ns = 450_000_000, .native_p99_ns = 550_000_000, .snapshot_p95_ns = 40_000_000, .rollback_8_p95_ns = 5_000_000_000, .max_workspace_bytes = 2 * 1024 * 1024 * 1024 } },
    .{ .kind = .mesh_heavy, .name = "MeshHeavy", .bodies = 257, .colliders = 257, .joints = 1, .broad_pairs = 2_048, .contact_patches = 2_048, .contact_points = 8_192, .expected_contacts = 256, .mesh_cells_per_axis = 16, .budget = .{ .native_p95_ns = 300_000_000, .native_p99_ns = 350_000_000, .snapshot_p95_ns = 8_000_000, .rollback_8_p95_ns = 2_500_000_000, .max_workspace_bytes = 256 * 1024 * 1024 } },
    .{ .kind = .joint_heavy, .name = "JointHeavy", .bodies = 2_048, .colliders = 2_048, .joints = 8_192, .broad_pairs = 4_096, .contact_patches = 4_096, .contact_points = 16_384, .expected_contacts = 0, .budget = .{ .native_p95_ns = 600_000_000, .native_p99_ns = 700_000_000, .snapshot_p95_ns = 20_000_000, .rollback_8_p95_ns = 5_000_000_000, .max_workspace_bytes = 768 * 1024 * 1024 } },
    .{ .kind = .ccd, .name = "CCD", .bodies = 1_024, .colliders = 1_024, .joints = 1, .broad_pairs = 4_096, .contact_patches = 4_096, .contact_points = 16_384, .expected_contacts = 512, .ccd_colliders = 512, .budget = .{ .native_p95_ns = 2_500_000_000, .native_p99_ns = 3_000_000_000, .snapshot_p95_ns = 16_000_000, .rollback_8_p95_ns = 20_000_000_000, .max_workspace_bytes = 384 * 1024 * 1024 } },
};
